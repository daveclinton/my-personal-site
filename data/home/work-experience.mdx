...
### Mobile & Frontend Engineer at Untapped Global
...
### Full Stack Engineer at Nuru Kenya
...
- **Frameworks/Libraries**: React, Vue.js, Django, Express.js, Next.js, React Native (Expo)
- **Version Control**: Git
- **Databases/ORM**: PostgreSQL, MongoDB, SQLite, Firebase, Supabase, Prisma, Drizzle
- **Testing**: Jest, Enzyme, Cypress
- **Other tools**: Remotion, React Fibre, Nx(monorepo)
